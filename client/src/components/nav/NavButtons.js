            ...
            case 'Profile':
                return (
                    <React.Fragment>
                        ...
                        {this.props.profileId === this.props.appState.userId ? <LogoutNavBtn appState={this.props.appState} logout={this.props.logout} /> : <ProfileNavBtn appState={this.props.appState} />}
                    </React.Fragment>
                );
            case 'About':
                return (
